...
// --- Truy vấn sản phẩm ---
$sql = "SELECT masp, tensp, tenlsp, mota, hinhanh, gia 
        FROM SANPHAM s 
...
for ($i = 1; $i <= $total_pages; $i++) {
    ...
    if (isset($_GET['idlsp'])) $params_url .= "&idlsp=" . (int)$_GET['idlsp'];
    $active = ($i == $page) ? "style='font-weight:bold; color:red'" : "";
    echo "<a href='index.php?$params_url' class='px-2' $active>$i</a>";
}
echo '</div>';
?>
